...
TITLE = 'Fan Signups'
PURPOSE = 'Mailing list signups collected at the merch table.'
TABLE = 'signups'
COLUMNS = [('email', 'text'), ('name', 'text'), ('source', 'text')]          # (name, sql type) in display order, excluding id
SEED = [['j.moreau@example.com', 'Juliette Moreau', 'Lisbon show'], ['dpark@example.com', 'Daniel Park', 'Madrid show'], ['s.ahmed@example.net', 'Sana Ahmed', 'website'], ['l.novak@example.com', 'Lena Novak', 'Paris show'], ['tobi.a@example.org', 'Tobi Adeyemi', 'website'], ['mchen@example.com', 'Mei Chen', 'Berlin show']]
