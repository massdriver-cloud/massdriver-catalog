...
PURPOSE = 'What is in stock, and where it is sitting right now.'
TABLE = 'items'
COLUMNS = [('sku', 'text'), ('item', 'text'), ('location', 'text'), ('qty', 'integer')]          # (name, sql type) in display order, excluding id
SEED = [['TS-BLK-M', 'Tour tee, black, M', 'Lisbon', '120'], ['TS-BLK-L', 'Tour tee, black, L', 'Lisbon', '96'], ['HD-NVY-L', 'Hoodie, navy, L', 'Warehouse', '48'], ['VN-LP-01', 'Vinyl LP, first press', 'Warehouse', '210'], ['PS-A2-03', 'Poster, A2', 'Madrid', '300'], ['TT-CAN-01', 'Enamel pin', 'Warehouse', '540']]
