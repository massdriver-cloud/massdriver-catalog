...
TITLE = 'Artist Portal'
PURPOSE = 'The roster, and who looks after each act.'
TABLE = 'artists'
COLUMNS = [('name', 'text'), ('genre', 'text'), ('manager', 'text')]          # (name, sql type) in display order, excluding id
SEED = [['Neon Harbour', 'synth-pop', 'R. Okafor'], ['The Salt Line', 'folk', 'M. Delgado'], ['Kite Season', 'indie rock', 'R. Okafor'], ['Ana Ferro', 'jazz', 'T. Whitfield'], ['Cold Aviary', 'post-punk', 'M. Delgado']]
