...
This bundle does NOT create any IAM bindings. Consumer bundles (e.g., `gcp-cloud-run-service`, `gcp-vertex-workbench`) create their own service accounts and bind the appropriate roles on this dataset when connected on the canvas.
